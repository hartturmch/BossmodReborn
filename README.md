...
1. Change: Added Sprint, Second Wind, Arms Length, Leg Sweep, True North, and class gap closer support to `Utility for Roles > Melee DPS Utility`; gap closer automation always keeps 1 charge for manual use.
